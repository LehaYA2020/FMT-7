...
public class LessonController {
    ...
    public ResponseEntity<?> create(@Validated(Create.class) @RequestBody Lesson lesson) {
    ...
    public ResponseEntity<?> update(@Validated(Update.class) @RequestBody Lesson lesson) {
